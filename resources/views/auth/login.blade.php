...
<body class="grayme">
    ...
    <div class="columns fulllogin">
        <div class="column is-offset-1 is-half leftsideeffect">
            ...
            <div class="is-mobile textboxlogin">
                <p class="title has-text-primary is-4 has-text-centered">เข้าสู่ระบบสมาชิก</p>
                <p class="subtitle  has-text-centered is-size-7 tinytextlogin">
                    กรอกอิเมลล์และรหัสผ่านเพื่อใช้ล๊อกอินเข้าสู่ระบบ</p>
            </div>
            <div class="loginform">
                    ...
                    <div class="field">
                        <p class="control has-icons-left has-icons-right">
                            <input
                                ...
                                id="email" type="email" value="{{ old('email') }}" name="email" placeholder="อิเมลล์"
                                autofocus>
    ...
    <div class="column is-one-third rightsideeffect has-background-primary">
        <div class="is-mobile textboxlogin textareabox">
            <p class="title has-text-white is-4 has-text-centered">สมัครสมาชิก</p>
            <p class="subtitle  has-text-white has-text-centered is-size-7 tinytextlogin">
                กรุณากรอกรายละเอียดเพื่อใช้งานระบบ</p>
