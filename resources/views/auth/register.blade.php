...
<head>
    ...
    <title>Join Now - NARAAgency</title>
...
<body class="grayme">
    ...
    <div class="columns fulllogin">
        <div class="column is-offset-1 is-half leftsideeffect">
            ...
            <div class="is-mobile textboxlogin">
                <p class="title has-text-primary is-4 has-text-centered">สมัครสมาชิก</p>
                <p class="subtitle  has-text-centered is-size-7 tinytextlogin">
                    กรุณากรอกอิเมลล์และรหัสผ่านเพื่อใช้ในการเข้าสู่ระบบ</p>
            </div>
            <div class="loginform">
                    ...
                    <div class="field">
                        <p class="control has-icons-left">
                            <input
                                ...
                                id="name" type="text" value="{{ old('name') }}" name="name" placeholder="ชื่อสกุล"
                                autofocus>
                    ...
                    <div class="field">
                        <p class="control has-icons-left">
                            <input
                                ...
                                id="password" type="password" name="password" placeholder="รหัสผ่าน" required>
                            <span class="icon is-small is-left">
    ...
    <div class="column is-one-third rightsideeffect has-background-primary">
        <div class="is-mobile textboxlogin textareabox">
            <p class="title has-text-white is-4 has-text-centered">เข้าสู่ระบบ</p>
            <p class="subtitle  has-text-white has-text-centered is-size-7 tinytextlogin">กรุณากรอกข้อมูลเพื่อใช้งานระบบ</p>
