...
<div class="column displaybox profileback">
  ...
  <nav class="breadcrumb has-arrow-separator profileback breadcrumbcss" aria-label="breadcrumbs">
    <ul>
      ...
      <li class="is-active"><a href="/admin">แดชบอร์ด</a></li>
    </ul>
  </nav>
  <div class="subtitle has-text-black-bis">ข้อมูลสรุป</div>
  <div class="columns">
    <div class="column">
        <div id="chart_div">
        </div>
  ...
  <hr>
  <div class="subtitle has-text-black-bis">บ้านล่าสุด</div>
  ...
  <hr>
  <div class="subtitle has-text-black-bis">ผู้ใช้ที่ลงทะเบียน</div>
  <div class="column tableshow style=" overflow-x: auto ">
            <table class="table ">
              <thead>
                <tr>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="/admin/user/{{$user->id}}/view" class="button is-info nounnounderlinebtn" target="_blank">ดูข้อมูล</a>
    </td>
    </tr>
    @endforeach
    </tbody>
