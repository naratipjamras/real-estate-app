<div class="column displaybox">
    ...
    <nav class="breadcrumb has-arrow-separator profileback breadcrumbcss" aria-label="breadcrumbs">
        <ul>
            ...
            <li class="is-active"><a href="/profile">เพิ่มผู้ใช้ใหม่</a></li>
        </ul>
    </nav>
    ...
    <div class="card cardmargin">
        <div class="containerx" style="padding: 0 10% 0 10%;">
            <h1 class="title has-text-centered">เพิ่มผู้ใช้ใหม่</h1>
            <form action="/admin/user/add" method="post" enctype="multipart/form-data">
              @csrf
              <div class="field">
                <label class="label">ชื่อ</label>
                <p class="control has-icons-left">
                  <input class="input" type="text" placeholder="ชื่อ" name="name">
              ...
              <div class="field">
                ...
                <p class="control has-icons-left">
                  <input class="input" type="email" placeholder="อิเมลล์" name="email">
                  <span class="icon is-small is-left">
                    <i class="fas fa-at"></i>
                  </span>
                </p>
          ...
          <div class="field">
            <p class="control has-text-centered">
              <button type="submit" class="button is-success">
                    <span class="buttonspace">เพิ่มผู้ใช้</span>
              </button>
            </p>
          </div>
          </form>
