...
<head>
  ...
  <title>Administrator Panel - NARAAgency</title>
    ...
    <div class="column is-one-fifth adminsidebar">
      <aside class="menu">
        ...
        <figure class="image is-96x96 profileavatar adminprofileavatar adminavatar" id="myBtn">
          ...
          <figcaption>
            <p class="has-text-centered has-text-white"><span><i class="fas fa-cloud-upload-alt"></i></span><br>เปลี่ยน
            </p>
          </figcaption>
        </figure>
        <p class="has-text-white is-4 is-size-7 has-text-weight-bold has-text-centered is-uppercase">
          {{Auth::user()->name}}</p>
        <p class="menu-label is-4 is-size-7 has-text-weight-bold has-text-dark is-uppercase">
          <i class="fas fa-pastafarianism"></i> ทั่วไป
        </p>
        <ul class="menu-list adminlistitem">
          <li><a href="/admin">แดชบอร์ด</a></li>
        </ul>
        <p class="menu-label is-4 is-size-7 has-text-weight-bold has-text-dark is-uppercase">
          <i class="fas fa-home"></i>จัดการบ้าน
        </p>
        <ul class="menu-list adminlistitem">
          <li><a href="/admin/property/all">ทั้งหมด</a></li>
          <li><a href="/admin/property/house">บ้านมือสอง</a></li>
          <li><a href="/admin/property/land">บ้านใหม่</a></li>
          <li><a href="/admin/property/building">บ้านเช่า</a></li>
          <li><a href="/admin/property/apartment">บ้านหลุดจำนอง</a></li>
{{--          <li><a href="/admin/property/warehouse">Warehouse</a></li>--}}
        ...
        <p class="menu-label has-text-dark is-4 is-size-7 has-text-weight-bold is-uppercase">
          <i class="fas fa-lock"></i> จัดการรายงาน
        </p>
        <ul class="menu-list adminlistitem">
          <li><a href="/admin/report"> ดูรายงาน</a></li>
        </ul>
        <p class="menu-label has-text-dark is-4 is-size-7 has-text-weight-bold is-uppercase">
          <i class="fab fa-blogger-b"></i> จัดการบทความ
        </p>
        <ul class="menu-list adminlistitem">
          <li><a href="/blog/new">บทความใหม่</a></li>
          <li><a href="/admin/articles"> ดูบทความทั้งหมด</a></li>
        </ul>
        <p class="menu-label has-text-dark is-4 is-size-7 has-text-weight-bold is-uppercase">
          <i class="fab fa-blogger-b"></i> จัดการความต้องการ
        </p>
        <ul class="menu-list adminlistitem">
          <li><a href="/admin/inquery/view">ดูความต้องการทั้งหมด</a></li>
        </ul>
        <p class="menu-label has-text-dark is-4 is-size-7 has-text-weight-bold is-uppercase">
          <i class="fas fa-users"></i> จัดการผู้ใช้
        </p>
        <ul class="menu-list adminlistitem">
          <li><a href="/admin/user/add">ผู้ใช้ใหม่</a></li>
          <li><a href="/admin/user/all">ดูผู้ใช้</a></li>
        </ul>
        <p class="menu-label has-text-dark is-4 is-size-7 has-text-weight-bold is-uppercase">
          <i class="fas fa-user-shield"></i>จัดการผู้ดูแลระบบ
        </p>
        <ul class="menu-list adminlistitem">
          <li><a href="/admin/admin/add">ผู้ดูแลระบบใหม่</a></li>
          <li><a href="/admin/admin/all">ดูแอดมินทั้งหมด</a></li>
        </ul>
        <p class="menu-label has-text-dark is-4 is-size-7 has-text-weight-bold is-uppercase">
          <i class="fas fa-cogs"></i> อื่นๆ
        </p>
        <ul class="menu-list adminlistitem">
          <li><a href="{{ route('admin.logout') }}">ออกจากระบบ</a></li>
        </ul>
      </aside>
    </div>
    @if(Request::is('admin'))
