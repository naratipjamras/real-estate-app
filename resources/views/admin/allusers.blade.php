<div class="column displaybox">
    ...
    <nav class="breadcrumb has-arrow-separator profileback breadcrumbcss" aria-label="breadcrumbs">
        <ul>
            ...
            <li class="is-active"><a href="/profile">ผู้ใช้ทั้งหมด</a></li>
        </ul>
    </nav>
    ...
    <div class="card cardmargin">
        <div class="containerx">
            <div class="subtitle has-text-black-bis">ผู้ใช้ทั้งหมด</div>
            <a href="/admin/user/add" class="button is-dark nounnounderlinebtn is-pulled-right">เพิ่มผู้ใช้ใหม่</a>
