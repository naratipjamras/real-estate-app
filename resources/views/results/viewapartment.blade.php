...
<head>
    ...
    <title>{{$apartment->property->name}} - NARAAgency</title>
...
<body>
    ...
    <div class="viewsection">
        ...
        <div class="containerx detailssection">
                        ...
                        <div class="is-pulled-left">
                            ...
                            <div class="columns">
                                <div class="column detailscolumn">
                                    <p>ประเภท: <span class="has-text-weight-semibold">{{$apartment->property->type}}</span></p>
                                    <p>ห้องนอน: <span class="has-text-weight-semibold">{{$apartment->noOfRooms}}</span></p>
                                    <p>ห้องครัว: <span class="has-text-weight-semibold">{{$apartment->noOfKitchen}}</span></p>
                                    <p>ห้องซักล้าง: <span class="has-text-weight-semibold">{{$apartment->noOfWashrooms}}</span></p>
                                    <p>ขนาดพื้นที่ (ตารางเมตร): <span class="has-text-weight-semibold">{{$apartment->size}}</span></p>
                                </div>
                                <div class="column">
                                    <p>โรงเรียนที่ใกล้ที่สุด: <span class="has-text-weight-semibold">{{$apartment->nearestSchool}}</span></p>
                                    <p>ป้ายรถเมย์ที่ไกล้ที่สุด: <span class="has-text-weight-semibold">{{$apartment->nearestRailway}}</span></p>
                                    <p>สถานีรถไฟที่ใกล้ที่สุด: <span class="has-text-weight-semibold">{{$apartment->nearestBusStop}}</span></p>
                                    <p>ความพร้อมอยู่: @if(strcmp($apartment->property->availability,"YES") == 0)
                                ...
                                <div class="column is-hidden-desktop">
                                    ...
                                    <div class="has-text-centered">
                                        <button class="button is-success" onclick="showPnox()">แสดงหมายเลขติดต่อ</button>
                                        ...
                                        <hr>
                                        <p class="owneramount">ราคา: <span class="has-text-success has-text-weight-bold">{{number_format($apartment->property->amount,2)}}</span>                                            บาท</p>
            ...
            <hr>
            <div class="subtitle has-text-weight-semibold" id="contactbox">เบอร์ติดต่อ</div>
            <div class="column is-flex-mobile">
                <form action="/apartment/{{$apartment->id}}/contactowner" method="post">
                    ...
                    <div class="field is-horizontal">
                        ...
                        <div class="field-body">
                            <div class="field">
                                <div class="control">
                                    <input class="input {{ $errors->has('subject') ? ' is-danger' : '' }}" type="text" placeholder="หัวข้อ" name="subject">
