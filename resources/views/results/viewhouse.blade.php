...
<body>
                        ...
                        <div class="is-pulled-left">
                            ...
                            <div class="columns">
                                <div class="column detailscolumn">
                                    <p>ประเภทบ้าน: <span class="has-text-weight-semibold">{{$house->property->type}}</span></p>
                                    <p>ห้องนอน: <span class="has-text-weight-semibold">{{$house->noOfRooms}}</span></p>
                                    <p>ห้องครัว: <span class="has-text-weight-semibold">{{$house->noOfKitchen}}</span></p>
                                    <p>ห้องซักล้าง: <span class="has-text-weight-semibold">{{$house->noOfWashrooms}}</span></p>
                                    <p>จำนวนชั้น: <span class="has-text-weight-semibold">{{$house->noOfFloors}}</span></p>
                                    <p>สวน: <span class="has-text-weight-semibold">{{$house->garden}}</span></p>
                                    <p>สระว่ายน้ำ: <span class="has-text-weight-semibold">{{$house->swimmingPool}}</span></p>
                                </div>
                                <div class="column">
                                    <p>ขนาดพื้นที่ (ตารางเมตร): <span class="has-text-weight-semibold">{{$house->size}}</span></p>
                                    <p>ใกล้โรงเรียน: <span class="has-text-weight-semibold">{{$house->nearestSchool}}</span></p>
                                    <p>ใกล้ป้ายรถเมย์: <span class="has-text-weight-semibold">{{$house->nearestRailway}}</span></p>
                                    <p>ใกล้สถานีรถไฟ: <span class="has-text-weight-semibold">{{$house->nearestBusStop}}</span></p>
                                    <p>พร้อมอยู่: @if(strcmp($house->property->availability,"YES") == 0)
                                ...
                                <div class="column is-hidden-desktop">
                                    ...
                                    <div class="has-text-centered">
                                        ...
                                        <hr>
                                        <p class="owneramount">ราคา: <span class="has-text-success has-text-weight-bold">{{number_format($house->property->amount,2)}}</span>                                            บาท</p>
                                        <p class="bidamount">ราคาล่าสุด: <span class="has-text-danger has-text-weight-bold">
    ...
    @include('results.offeralerts')
                ...
                <div class="column is-hidden-touch">
                    ...
                    <div class="subtitle has-text-centered"><span>@</span>{{$house->property->user->name}}</div>
                    <div class="has-text-centered">
                        <button class="button is-dark" onclick="location.href='#contactbox'">อิเมล์เจ้าของ</button>
                        <button class="button is-success" onclick="showPno()">โทรหาเจ้าของ</button>
    ...
    @include('results.offeralerts')
            ...
            <div class=" is-flex-mobile"> --}}
                ...
                <a class="button is-info nounnounderlinebtn" href="http://www.google.com/maps/place/{{$house->property->latitude}},{{$house->property->longitude}}"
                    target="_blank">ไปยังแผนที่</a> {{-- </div> --}}
            <hr>
            ...
            <hr>
            <div class="subtitle has-text-weight-semibold" id="contactbox">ติดต่อเจ้าของ</div>
            <div class="column is-flex-mobile">
                <form action="/house/{{$house->id}}/contactowner" method="post">
                    ...
                    <div class="field is-horizontal">
                        ...
                        <div class="field-body">
                            <div class="field is-expanded">
                                ...
                                <p class="help has-text-link">กรอกเบอร์โทร</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="field is-horizontal">
                        ...
                        <div class="field-body">
                            <div class="field">
                                <div class="control">
                                    <textarea class="textarea {{ $errors->has('message') ? ' is-danger' : '' }}" placeholder="รายละเอียด" name="message"></textarea>
