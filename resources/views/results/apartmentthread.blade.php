            ...
            <div class="card-content">
                <div class="media">
                    ...
                    <div class="media-content">
                        ...
                        <p class="title is-4 has-text-dark">{{number_format($apartment->property->amount,2)}} บาท</p>
                ...
                <div class="content">
                    ...
                    <a href="/apartment/{{$apartment->id}}"><button class="button is-link is-pulled-right">ดูรายละเอียด</button></a>
                </div>
            </div>
        </div>
    </div>
