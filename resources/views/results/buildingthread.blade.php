            ...
            <div class="card-content">
                <div class="media">
                    ...
                    <div class="media-content">
                        ...
                        <p class="title is-4 has-text-dark">{{number_format($building->property->amount,2)}} บาท</p>
                ...
                <div class="content">
                    ...
                    <a href="/building/{{$building->id}}"><button class="button is-link is-pulled-right">ดูรายละเอียด</button></a>
                </div>
            </div>
        </div>
    </div>
