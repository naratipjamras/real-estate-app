<div class="modal repo" id="reportModal">
  ...
  <div class="modal-card">
    ...
    <footer class="modal-card-foot is-centered has-text-centered">
      <p class="subtitle is-7 has-text-centered" style="margin-left: 12%;">Thank you for your report, our staff will look into this report and take further actions. <br> <strong>NARAAgency - Leader in Real Estate Business</strong></p>
    </footer>
  </div>
</div>
