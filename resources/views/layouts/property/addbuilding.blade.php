...
<body>
    ...
    <br>
    <div class="title has-text-centered">เพิ่มบ้านเช่า</div>
    <br>
    <div class="container">
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="columns">
                <div class="column">
                    ...
                    <div class="field">
                        <div class="control">
                            <label for="name">หมายเลขติดต่อ</label>
                    ...
                    <div class="field">
                        <div class="control">
                            <label for="img">ภาพ <strong class="is-small">(Tip: ขนาดภาพอัพโหลดสูงสุด [Max
                                    Image Size: 4MB])</strong></label>
                            <div class="input-group control-group increment">
                                <input type="file" name="filename[]" class="form-control">
                                <div class="input-group-btn">
                                    <button class="button is-success addmore" type="button"><i
                                            class="glyphicon glyphicon-plus"></i>เพิ่มภาพ</button>
                                </div>
                            </div>
                    ...
                    <div class="field">
                        <div class="control maphere">
                            <label for="name">ตำแหน่ง: Google Maps</label>
                ...
                <div class="column">
                        ...
                        <div class="control">
                            ...
                            <div class="select is-primary">
                                <select name="agreement">
                                    <option value="lease" selected>เช่า</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="field">
                        <div class="control">
                            <label for="name">โรงเรียนที่ไกล้ที่สุด</label>
