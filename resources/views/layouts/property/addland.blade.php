...
<body>
    ...
    <br>
    <div class="title has-text-centered">เพิ่มบ้านใหม่</div>
    <br>
    <div class="container">
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="columns">
                <div class="column">
                    ...
                    <div class="field">
                        <div class="control">
                            <label for="name">ราคาบ้าน <strong>(บาท)</strong></label>
                    ...
                    <div class="field">
                        <div class="control">
                            <label for="name">อิเมลล์ติดต่อ</label>
                    ...
                    <div class="field">
                        <div class="control">
                            <label for="img">ภาพ <strong class="is-small">(Tip: อัพโหลดภาพขนาดสูงสุดไม่เกิน [Max
                    ...
                    <div class="field">
                        <div class="control maphere">
                            <label for="name">ที่ตั้ง: Google Maps</label>
                ...
                <div class="column">
                    ...
                    <div class="field">
                        <div class="control">
                            <label for="name">ระบบน้ําประปา</label>
                            <br>
