    ...
    <div class="column is-full is-mobile backgroundimg">
        ...
        <div class="container">
            <div class="has-text-centered centertext">
                ...
                <h1 class="has-text-white centertextword">ติดต่อเรา</h1>
            </div>
        </div>
    </div>
    {{-- <div class="columns">
        ...
        <div class="column coloredback">
            ...
            <div class="insidemoved">
                <form action="/sendmessage" method="post">
                  @csrf
                    <div class="field">
                      <label class="label has-text-white">ชื่อสกุล</label>
                      <div class="control">
                    ...
                    <div class="field">
                      <label class="label has-text-white">อิเมลล์</label>
                      <div class="control">
                    ...
                    <div class="field">
                      <label class="label has-text-white">เรื่องเกี่ยวกับ</label>
                      <div class="control">
                    ...
                    <div class="field">
                      <label class="label has-text-white">ข้อความ</label>
                      <div class="control">
