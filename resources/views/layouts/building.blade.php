...
<head>
  ...
  <title>NARAAgency - Leader in Real Esate Business</title>

  {{-- CSS Files --}}
  <link rel="stylesheet" href="/css/bulma.min.css">
  <link rel="stylesheet" href="/css/mortagagehouse.css"> {{-- Google Fonts --}}
    ...
    <div class="container">
      <div class="columns is-mobile is-centered">
        <div class="column is-8 searchbox">
          <h1 class="subtitle is-4 has-text-white searchboxtitletext">ค้นหาบ้าน</h1>
          <div class="tabs">
            <ul>
              <li class="deadtabitem">
                <a href="/house">
                          <span class="has-text-white">บ้านมือสอง</span>
                        </a>
              </li>
              <li class="deadtabitem">
                <a href="/land">
                          <span class="has-text-white">บ้านใหม่</span>
                        </a>
              </li>
              <li class="deadtabitem">
                  <a href="/apartment">
                          <span class="has-text-white">เช่าบ้าน</span>
                        </a>
              </li>
              <li class="is-active has-background-primary tabitem">
                <a href="/building">
                          <span class="has-text-white">บ้านหลุดจำนอง</span>
                        </a>
              </li>
{{--              <li class="deadtabitem">--}}
{{--                <a href="/warehouse">--}}
          ...
          <form method="POST" action="/building/search/">
            ...
            <div class="field has-addons searchinput">
              <p class="control has-icons-left is-expanded">
                <input class="input is-large inputsearchbox" type="text" placeholder="ค้นหาทำเล ย่าน สถานที่" id="search" name="searchquery">
                <span class="icon is-small is-left">
                            <i class="fas fa-search"></i>
                          </span>
              </p>
              <div class="control">
                <button class="button inputsearchbox is-primary is-large"><p class="subtitle is-6 has-text-white">ค้นหา</p></button>
              </div>
            </div>
