        ...
        <div class="column is-one-fifth sidebar">
            <aside class="menu">
                <figure class="image is-128x128 profileavatar" id="myBtn">
                    ...
                    <figcaption>
                      <h5 class="has-text-centered has-text-white"><span><i class="fas fa-cloud-upload-alt"></i></span><br>เปลี่ยน</h5>
                    </figcaption>
                </figure>
                <p class="has-text-dark has-text-centered is-4 is-size-7 has-text-weight-bold is-uppercase">{{auth()->user()->name}}</p>
                <p class="menu-label has-text-link is-4 is-size-7 has-text-weight-bold is-uppercase">
                  ทั่วไป
                </p>
                <ul class="menu-list listitem is-size-6">
                  <li><a href="/profile">แดชบอร์ด</a></li>
                  <li><a href="/profile/myfavorite">รายการโปรด</a></li>
                  <li><a href="/profile/myoffers">ข้อเสนอ</a></li>
                  <li><a href="/profile/message">กล่องช้อความ</a></li>
                </ul>
                <p class="menu-label has-text-link is-4 is-size-7 has-text-weight-bold is-uppercase">
                  จัดการ
                </p>
                <ul class="menu-list listitem">
                  <li><a href="/profile/editaccount">แก้ไขข้อมูลโปรไฟล์</a></li>
                  <li><a href="/profile/changepassword">เปลี่ยนรหัสผ่าน</a></li>
                  <li><a href="/profile/deleteaccount">ลบบัญชี</a></li>
                </ul>
                <p class="menu-label has-text-link is-4 is-size-7 has-text-weight-bold is-uppercase">
                  รายละเอียด
                </p>
                <ul class="menu-list listitem">
                  <li><a href="/profile/myhouse">บ้านมือสอง</a></li>
                  <li><a href="/profile/myland">บ้านใหม่</a></li>
                  <li><a href="/profile/mybuilding">บ้านเช่า</a></li>
                  <li><a href="/profile/myapartment">บ้านหลุดจำนอง</a></li>
                  ...
                  @csrf
                    <div class="file has-name is-centered">
                        ...
                        <div class="field is-centered has-text-centered">
                          <button type="submit" class="button is-primary"><span class="savebutton">บันทึก</span></button>
                        </div>
                </form>
            </div>
        </div>
