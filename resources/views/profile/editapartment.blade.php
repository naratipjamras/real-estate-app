<div class="column displaybox">
        ...
        <nav class="breadcrumb has-arrow-separator profileback breadcrumbcss" aria-label="breadcrumbs">
            <ul>
                ...
                <li class="is-active"><a href="/profile">แก้ไขข้อมูลบ้านหลุดจำนอง</a></li>
            </ul>
        </nav>
        ...
        <div class="card cardmargin">
            <div class="containerx">
                ...
                <h1 class="title has-text-centered">แก้ไขข้อมูลบ้านหลุดจำนอง</h1>
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="columns">
                        <div class="column">
                            ...
                            <div class="field">
                                <div class="control">
                                    ...
                                    <div class="select is-primary is-full">
                                        <select name="type">
                                        <option value="Apartment">บ้านหลุดจำนอง</option>
                                    </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="field">
                                <div class="control">
                                    <label for="img">ภาพ <strong class="is-small">(Tip: อัพโหลดภาพขนาดสูงสุด [Max Image Size: 4MB])</strong></label>
                                    <div class="contetnt">
