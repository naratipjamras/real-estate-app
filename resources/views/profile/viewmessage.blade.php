<div class="column displaybox">
  ...
  <nav class="breadcrumb has-arrow-separator profileback breadcrumbcss" aria-label="breadcrumbs">
    <ul>
      ...
      <li class="is-active"><a href="/profile">ดูข้อความ</a></li>
    </ul>
  </nav>
          ...
          <div class="top">
            <div>
              ...
              <div class="address">
                ...
                <div class="is-7"><span class="subtitle is-7">จาก: {{$message->senderName}}
                    @if($message->sender_id == 0)
                      <span class="subtitle is-7 has-text-black-bis has-text-weight-bold"> (ผู้ใช้ทั่วไป) </span>
                    @else
                      <span class="subtitle is-7 has-text-black-bis has-text-weight-bold"> (ผู้ใช้ลงทะเบียน) </span>
                    @endif
                  </span>
                </div>
                <div class="subtitle is-7">รายละเอียด:<span class="subtitle is-7"> {{$message->senderMail}} | {{$message->phoneNo}}</span></div>
                <div class="subtitle is-7 is-pulled-right">เกี่ยวกับ :<span class="subtitle is-7"> <a href="/{{$message->property_url}}" target="_blank">ดูรายละเอียด</a></span>
                <br>
